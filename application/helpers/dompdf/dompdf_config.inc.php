 ...
 */
define("DOMPDF_INC_DIR", DOMPDF_DIR . DIRECTORY_SEPARATOR."include");
...
function DOMPDF_autoload($class) {
  ...
  if($filename != "ci_exceptions.cls.php"){
  	require_once(DOMPDF_INC_DIR . DIRECTORY_SEPARATOR."$filename");
  }
}
...
require_once(DOMPDF_INC_DIR . DIRECTORY_SEPARATOR."functions.inc.php");
