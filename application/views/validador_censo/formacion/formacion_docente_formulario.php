        ...
        $('#btn_guardar_formacion_docente').on('click', function() {
        	if($('#idc').length){ //Validar carga de archivo
        		if($("#userfile").val()==""){ //Validar carga de archivo
            		data_ajax(site_url+'/validacion_censo_profesores/formacion_docente_formulario/<?php echo $identificador; ?>', '#formulario_formacion_docente', '#modal_content');
            	} else {
