...
<?php   echo form_open('account/middle_password_reset/'.$token_activate_middle.'/', array('id'=>'endup_password_reset')); 
    ...
    <div class="panel">
        <div class="panel-body">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"> 
                <?php
                    if (isset($step_success) && !empty($step_success)) {                        
                        echo html_message($step_success, 'success');
                    }
                ...
                <div class="form-group  <?php echo $has_error_mail; ?>">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <p class="help-block">Nueva contraseña</p>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 text-danger">
                        <?php   echo form_error_format('nueva_contrasenia'); ?>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group  <?php echo $has_error_mail; ?>">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <p class="help-block">Confirmar nueva contraseña</p>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <?php
                                echo $this->form_complete->create_element(
                                            array(
                                                    'id'=>'confirma_nueva_contrasenia', 
                                                    'type'=>'password', 
                                                    'attributes'=>array(
                                                            'class'=>'form-control',
                                                            'maxlength'=>'50', 
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 text-danger">
                        <?php   echo form_error_format('confirma_nueva_contrasenia'); ?>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <button id="btn_envia_cod_rec" type="button" class="btn btn-info btn-block" onclick="guardaNuevaContrasenia();">Guardar nueva contraseña</button>
                    </div>
                </div>                
            </div>
        </div>
    </div>
<?php   echo form_close();  //onclick="guardaNuevaContrasenia();" ?>
